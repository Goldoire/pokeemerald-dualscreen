...
ModernEmeraldConfig gModernEmeraldConfig = {0};
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_NUZLOCKE:
        ...
        case MENUITEM_NUZLOCKE_SPECIES_CLAUSE:
            if ((gModernEmeraldConfig.tx_Nuzlocke_EasyMode) == 0)
...
static void VBlankCB(void)
{
    //printf("[TxMenu] VBlankCB start\n"); fflush(stdout);
    LoadOam();
    ProcessSpriteCopyRequests();
    TransferPlttBuffer();
    //printf("[TxMenu] VBlankCB done\n"); fflush(stdout);
}
...
void CB2_InitTxRandomizerChallengesMenu(void)
{
    ...
    case 6:
        ...
        gModernEmeraldConfig.tx_Mode_Encounters                  = TX_MODE_ALTERNATE_SPAWNS;
        gModernEmeraldConfig.tx_Mode_InfiniteTMs                 = TX_MODE_INFINITE_TMS;
        gModernEmeraldConfig.tx_Mode_PoisonSurvive               = TX_MODE_SURVIVE_POISON;
        gModernEmeraldConfig.tx_Mode_Synchronize                 = TX_MODE_NEW_SYNCHRONIZE;
        gModernEmeraldConfig.tx_Mode_Mints                       = TX_MODE_MINTS;
        gModernEmeraldConfig.tx_Mode_New_Citrus                  = TX_MODE_NEW_CITRUS;
        gModernEmeraldConfig.tx_Mode_Modern_Types                = TX_MODE_MODERN_TYPES;
        gModernEmeraldConfig.tx_Mode_Fairy_Types                 = TX_MODE_FAIRY_TYPES;
        gModernEmeraldConfig.tx_Mode_New_Stats                   = TX_MODE_NEW_STATS;
        gModernEmeraldConfig.tx_Mode_Sturdy                      = TX_MODE_STURDY;
        gModernEmeraldConfig.tx_Mode_Modern_Moves                = TX_MODE_MODERN_MOVES;
        gModernEmeraldConfig.tx_Mode_Legendary_Abilities         = TX_MODE_LEGENDARY_ABILITIES;
        gModernEmeraldConfig.tx_Mode_New_Legendaries             = TX_MODE_NEW_LEGENDARIES;
        gModernEmeraldConfig.tx_Mode_TypeEffectiveness           = TX_MODE_TYPE_EFFECTIVENESS;

        gModernEmeraldConfig.tx_Features_RTCType                 = TX_FEATURES_RTC_TYPE;
        gModernEmeraldConfig.tx_Features_ShinyChance             = TX_FEATURES_SHINY_CHANCE;
        gModernEmeraldConfig.tx_Features_WildMonDropItems        = TX_FEATURES_ITEM_DROP;
        gModernEmeraldConfig.tx_Features_EasierFeebas            = TX_FEATURES_EASIER_FEEBAS;
        gModernEmeraldConfig.tx_Features_Unlimited_WT            = TX_FEATURES_UNLIMITED_WT;
        gModernEmeraldConfig.tx_Features_FrontierBans            = TX_FEATURES_FRONTIER_BANS;
        gModernEmeraldConfig.tx_Features_ShinyColors             = TX_FEATURES_SHINY_COLORS;

        gModernEmeraldConfig.tx_Random_Starter                   = TX_RANDOM_STARTER;
        gModernEmeraldConfig.tx_Random_WildPokemon               = TX_RANDOM_WILD_POKEMON;
        gModernEmeraldConfig.tx_Random_Trainer                   = TX_RANDOM_TRAINER;
        gModernEmeraldConfig.tx_Random_Static                    = TX_RANDOM_STATIC;
        gModernEmeraldConfig.tx_Random_Similar                   = TX_RANDOM_SIMILAR;
        gModernEmeraldConfig.tx_Random_MapBased                  = TX_RANDOM_MAP_BASED;
        gModernEmeraldConfig.tx_Random_IncludeLegendaries        = TX_RANDOM_INCLUDE_LEGENDARIES;
        gModernEmeraldConfig.tx_Random_Type                      = TX_RANDOM_TYPE;
        gModernEmeraldConfig.tx_Random_Moves                     = TX_RANDOM_MOVES;
        gModernEmeraldConfig.tx_Random_Abilities                 = TX_RANDOM_ABILITIES;
        gModernEmeraldConfig.tx_Random_Evolutions                = TX_RANDOM_EVOLUTION;
        gModernEmeraldConfig.tx_Random_EvolutionMethods          = TX_RANDOM_EVOLUTION_METHODE;
        gModernEmeraldConfig.tx_Random_TypeEffectiveness         = TX_RANDOM_TYPE_EFFECTIVENESS;
        gModernEmeraldConfig.tx_Random_Items                     = TX_RANDOM_ITEMS;
        gModernEmeraldConfig.tx_Random_Chaos                     = TX_RANDOM_CHAOS_MODE;
        gModernEmeraldConfig.tx_Challenges_LessEscapes           = TX_CHALLENGES_LESS_ESCAPES;

        gModernEmeraldConfig.tx_Nuzlocke_EasyMode               = TX_NUZLOCKE_MINI_MODE;
        gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke              = TX_NUZLOCKE_NUZLOCKE;
        gModernEmeraldConfig.tx_Nuzlocke_NuzlockeHardcore      = TX_NUZLOCKE_NUZLOCKE_HARDCORE;
        gModernEmeraldConfig.tx_Nuzlocke_SpeciesClause           = TX_NUZLOCKE_SPECIES_CLAUSE;
        gModernEmeraldConfig.tx_Nuzlocke_ShinyClause             = TX_NUZLOCKE_SHINY_CLAUSE;
        gModernEmeraldConfig.tx_Nuzlocke_Nicknaming              = TX_NUZLOCKE_NICKNAMING;
        gModernEmeraldConfig.tx_Nuzlocke_Deletion                = TX_NUZLOCKE_DELETION;

        gModernEmeraldConfig.tx_Difficulty_PartyLimit            = TX_DIFFICULTY_PARTY_LIMIT;
        gModernEmeraldConfig.tx_Challenges_LevelCap              = TX_DIFFICULTY_LEVEL_CAP;
        gModernEmeraldConfig.tx_Challenges_ExpMultiplier         = TX_DIFFICULTY_EXP_MULTIPLIER;
        gModernEmeraldConfig.tx_Challenges_NoItemPlayer          = TX_DIFFICULTY_NO_ITEM_PLAYER;
        gModernEmeraldConfig.tx_Challenges_NoItemTrainer         = TX_DIFFICULTY_NO_ITEM_TRAINER;
        gModernEmeraldConfig.tx_Challenges_NoEVs                 = TX_DIFFICULTY_NO_EVS;
        gModernEmeraldConfig.tx_Challenges_TrainerScalingIVs     = TX_DIFFICULTY_SCALING_IVS;
        gModernEmeraldConfig.tx_Challenges_TrainerScalingEVs     = TX_DIFFICULTY_SCALING_EVS;
        gModernEmeraldConfig.tx_Challenges_PkmnCenter            = TX_DIFFICULTY_PKMN_CENTER;
        gModernEmeraldConfig.tx_Features_LimitDifficulty         = TX_DIFFICULTY_LIMIT_DIFFICULTY;
        gModernEmeraldConfig.tx_Challenges_MaxPartyIVs           = TX_DIFFICULTY_MAX_PARTY_IVS;
        gModernEmeraldConfig.tx_Difficulty_EscapeRopeDig         = TX_DIFFICULTY_ESCAPE_ROPE_DIG;
        gModernEmeraldConfig.tx_Difficulty_HardExp               = TX_DIFFICULTY_HARD_EXP;

        gModernEmeraldConfig.tx_Challenges_PCHeal                = TX_CHALLENGE_PCHEAL;
        gModernEmeraldConfig.tx_Challenges_Expensive             = TX_CHALLENGES_EXPENSIVE;
        gModernEmeraldConfig.tx_Challenges_EvoLimit              = TX_CHALLENGE_EVO_LIMIT;
        gModernEmeraldConfig.tx_Challenges_OneTypeChallenge      = TX_CHALLENGE_TYPE;
        gModernEmeraldConfig.tx_Challenges_BaseStatEqualizer     = TX_CHALLENGE_BASE_STAT_EQUALIZER;
        gModernEmeraldConfig.tx_Challenges_Mirror                = TX_CHALLENGE_MIRROR;
        gModernEmeraldConfig.tx_Challenges_Mirror_Thief          = TX_CHALLENGE_MIRROR_THIEF;


        sOptions = AllocZeroed(sizeof(*sOptions));
        //MENU MODE
        sOptions->sel_mode[MENUITEM_MODE_CLASSIC_MODERN]         = FALSE;
        sOptions->sel_mode[MENUITEM_MODE_ALTERNATE_SPAWNS]       = gModernEmeraldConfig.tx_Mode_Encounters;
        sOptions->sel_mode[MENUITEM_MODE_INFINITE_TMS]           = gModernEmeraldConfig.tx_Mode_InfiniteTMs;
        sOptions->sel_mode[MENUITEM_MODE_SURVIVE_POISON]         = gModernEmeraldConfig.tx_Mode_PoisonSurvive;
        sOptions->sel_mode[MENUITEM_MODE_SYNCHRONIZE]            = gModernEmeraldConfig.tx_Mode_Synchronize;
        sOptions->sel_mode[MENUITEM_MODE_MINTS]                  = gModernEmeraldConfig.tx_Mode_Mints;
        sOptions->sel_mode[MENUITEM_MODE_NEW_CITRUS]             = gModernEmeraldConfig.tx_Mode_New_Citrus;
        sOptions->sel_mode[MENUITEM_MODE_MODERN_TYPES]           = gModernEmeraldConfig.tx_Mode_Modern_Types;
        sOptions->sel_mode[MENUITEM_MODE_FAIRY_TYPES]            = gModernEmeraldConfig.tx_Mode_Fairy_Types;
        sOptions->sel_mode[MENUITEM_MODE_NEW_STATS]              = gModernEmeraldConfig.tx_Mode_New_Stats;
        sOptions->sel_mode[MENUITEM_MODE_STURDY]                 = gModernEmeraldConfig.tx_Mode_Sturdy;
        sOptions->sel_mode[MENUITEM_MODE_MODERN_MOVES]           = gModernEmeraldConfig.tx_Mode_Modern_Moves;
        sOptions->sel_mode[MENUITEM_MODE_LEGENDARY_ABILITIES]    = gModernEmeraldConfig.tx_Mode_Legendary_Abilities;
        sOptions->sel_mode[MENUITEM_MODE_NEW_LEGENDARIES]        = gModernEmeraldConfig.tx_Mode_New_Legendaries;
        sOptions->sel_mode[MENUITEM_MODE_NEW_EFFECTIVENESS]      = gModernEmeraldConfig.tx_Mode_TypeEffectiveness;
        //MENU FEATURES
        sOptions->sel_features[MENUITEM_FEATURES_RTC_TYPE]               = gModernEmeraldConfig.tx_Features_RTCType;
        sOptions->sel_features[MENUITEM_FEATURES_SHINY_CHANCE]           = gModernEmeraldConfig.tx_Features_ShinyChance;
        sOptions->sel_features[MENUITEM_FEATURES_ITEM_DROP]              = gModernEmeraldConfig.tx_Features_WildMonDropItems;
        sOptions->sel_features[MENUITEM_FEATURES_EASY_FEEBAS]            = gModernEmeraldConfig.tx_Features_EasierFeebas;
        sOptions->sel_features[MENUITEM_FEATURES_UNLIMITED_WT]           = gModernEmeraldConfig.tx_Features_Unlimited_WT;
        sOptions->sel_features[MENUITEM_FEATURES_FRONTIER_BANS]          = gModernEmeraldConfig.tx_Features_FrontierBans;
        sOptions->sel_features[MENUITEM_FEATURES_SHINY_COLOR]            = gModernEmeraldConfig.tx_Features_ShinyColors;

        //MENU RANDOMIZER
        sOptions->sel_randomizer[MENUITEM_RANDOM_OFF_ON]                     = FALSE;
        sOptions->sel_randomizer[MENUITEM_RANDOM_STARTER]                    = gModernEmeraldConfig.tx_Random_Starter;
        sOptions->sel_randomizer[MENUITEM_RANDOM_WILD_PKMN]                  = gModernEmeraldConfig.tx_Random_WildPokemon;
        sOptions->sel_randomizer[MENUITEM_RANDOM_TRAINER]                    = gModernEmeraldConfig.tx_Random_Trainer;
        sOptions->sel_randomizer[MENUITEM_RANDOM_STATIC]                     = gModernEmeraldConfig.tx_Random_Static;
        sOptions->sel_randomizer[MENUITEM_RANDOM_SIMILAR_EVOLUTION_LEVEL]    = !gModernEmeraldConfig.tx_Random_Similar;
        sOptions->sel_randomizer[MENUITEM_RANDOM_INCLUDE_LEGENDARIES]        = gModernEmeraldConfig.tx_Random_IncludeLegendaries;
        sOptions->sel_randomizer[MENUITEM_RANDOM_TYPE]                       = gModernEmeraldConfig.tx_Random_Type;
        sOptions->sel_randomizer[MENUITEM_RANDOM_MOVES]                      = gModernEmeraldConfig.tx_Random_Moves;
        sOptions->sel_randomizer[MENUITEM_RANDOM_ABILITIES]                  = gModernEmeraldConfig.tx_Random_Abilities;
        sOptions->sel_randomizer[MENUITEM_RANDOM_EVOLUTIONS]                 = gModernEmeraldConfig.tx_Random_Evolutions;
        sOptions->sel_randomizer[MENUITEM_RANDOM_EVOLUTIONS_METHODS]         = gModernEmeraldConfig.tx_Random_EvolutionMethods;
        sOptions->sel_randomizer[MENUITEM_RANDOM_TYPE_EFFEC]                 = gModernEmeraldConfig.tx_Random_TypeEffectiveness;
        sOptions->sel_randomizer[MENUITEM_RANDOM_ITEMS]                      = gModernEmeraldConfig.tx_Random_Items;
        sOptions->sel_randomizer[MENUITEM_RANDOM_CHAOS]                      = gModernEmeraldConfig.tx_Random_Chaos;

        // MENU_NUZLOCKE
        if (gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke && gModernEmeraldConfig.tx_Nuzlocke_NuzlockeHardcore)
            sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NUZLOCKE] = 2;
        else if (gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke)
            sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NUZLOCKE] = 1;
        else if (gModernEmeraldConfig.tx_Nuzlocke_EasyMode)
            sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NUZLOCKE] = 0;
        else
            sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NUZLOCKE] = 0;
        sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_SPECIES_CLAUSE]    = !gModernEmeraldConfig.tx_Nuzlocke_SpeciesClause;
        sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_SHINY_CLAUSE]      = !gModernEmeraldConfig.tx_Nuzlocke_ShinyClause;
        sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NICKNAMING]        = !gModernEmeraldConfig.tx_Nuzlocke_Nicknaming;
        sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_DELETION]          = gModernEmeraldConfig.tx_Nuzlocke_Deletion;

        // MENU_DIFFICULTY
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_PARTY_LIMIT]    = gModernEmeraldConfig.tx_Difficulty_PartyLimit;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_LEVEL_CAP]      = gModernEmeraldConfig.tx_Challenges_LevelCap;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_EXP_MULTIPLIER] = gModernEmeraldConfig.tx_Challenges_ExpMultiplier;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_LESS_ESCAPES]   = gModernEmeraldConfig.tx_Challenges_LessEscapes;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_ITEM_PLAYER]    = gModernEmeraldConfig.tx_Challenges_NoItemPlayer;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_ITEM_TRAINER]   = gModernEmeraldConfig.tx_Challenges_NoItemTrainer;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_NO_EVS]         = gModernEmeraldConfig.tx_Challenges_NoEVs;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_SCALING_IVS]    = gModernEmeraldConfig.tx_Challenges_TrainerScalingIVs;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_SCALING_EVS]    = gModernEmeraldConfig.tx_Challenges_TrainerScalingEVs;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_LIMIT_DIFFICULTY]      = gModernEmeraldConfig.tx_Features_LimitDifficulty;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_MAX_PARTY_IVS]         = gModernEmeraldConfig.tx_Challenges_MaxPartyIVs;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_ESCAPE_ROPE_DIG]       = gModernEmeraldConfig.tx_Difficulty_EscapeRopeDig;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_HARD_EXP]              = gModernEmeraldConfig.tx_Difficulty_HardExp;
        sOptions->sel_difficulty[MENUITEM_DIFFICULTY_CATCH_RATE]             = gModernEmeraldConfig.tx_Difficulty_CatchRate;
        // MENU_CHALLENGES
        sOptions->sel_challenges[MENUITEM_DIFFICULTY_POKECENTER]             = gModernEmeraldConfig.tx_Challenges_PkmnCenter;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_PCHEAL]                 = gModernEmeraldConfig.tx_Challenges_PCHeal;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_EXPENSIVE]              = gModernEmeraldConfig.tx_Challenges_Expensive;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_EVO_LIMIT]              = gModernEmeraldConfig.tx_Challenges_EvoLimit;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE]     = gModernEmeraldConfig.tx_Challenges_OneTypeChallenge;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_BASE_STAT_EQUALIZER]    = gModernEmeraldConfig.tx_Challenges_BaseStatEqualizer;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_MIRROR]                 = gModernEmeraldConfig.tx_Challenges_Mirror;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_MIRROR_THIEF]           = gModernEmeraldConfig.tx_Challenges_Mirror_Thief;
    ...
    case 10:
        ...
        sOptions->arrowScrollOffset = 0;
        sOptions->arrowTaskId = AddScrollIndicatorArrowPairParameterized(SCROLL_ARROW_UP, 240 / 2, 20, 110, MENUITEM_MODE_COUNT - 1, 110, 110, &sOptions->arrowScrollOffset);
...
static void Task_OptionMenuProcessInput(u8 taskId)
{
    ...
    sOptions->arrowScrollOffset = sOptions->menuCursor[sOptions->submenu];
...
void SaveData_TxRandomizerAndChallenges(void)
{
    ...
    //MENU MODE
    gModernEmeraldConfig.tx_Mode_Encounters                  = sOptions->sel_mode[MENUITEM_MODE_ALTERNATE_SPAWNS];
    gModernEmeraldConfig.tx_Mode_InfiniteTMs                 = sOptions->sel_mode[MENUITEM_MODE_INFINITE_TMS];
    gModernEmeraldConfig.tx_Mode_PoisonSurvive               = sOptions->sel_mode[MENUITEM_MODE_SURVIVE_POISON];
    gModernEmeraldConfig.tx_Mode_Synchronize                 = sOptions->sel_mode[MENUITEM_MODE_SYNCHRONIZE];
    gModernEmeraldConfig.tx_Mode_Mints                       = sOptions->sel_mode[MENUITEM_MODE_MINTS];
    gModernEmeraldConfig.tx_Mode_New_Citrus                  = sOptions->sel_mode[MENUITEM_MODE_NEW_CITRUS];
    gModernEmeraldConfig.tx_Mode_Modern_Types                = sOptions->sel_mode[MENUITEM_MODE_MODERN_TYPES];
    gModernEmeraldConfig.tx_Mode_Fairy_Types                 = sOptions->sel_mode[MENUITEM_MODE_FAIRY_TYPES];
    gModernEmeraldConfig.tx_Mode_New_Stats                   = sOptions->sel_mode[MENUITEM_MODE_NEW_STATS];
    gModernEmeraldConfig.tx_Mode_Sturdy                      = sOptions->sel_mode[MENUITEM_MODE_STURDY];
    gModernEmeraldConfig.tx_Mode_Modern_Moves                = sOptions->sel_mode[MENUITEM_MODE_MODERN_MOVES];
    gModernEmeraldConfig.tx_Mode_Legendary_Abilities         = sOptions->sel_mode[MENUITEM_MODE_LEGENDARY_ABILITIES];
    gModernEmeraldConfig.tx_Mode_New_Legendaries             = sOptions->sel_mode[MENUITEM_MODE_NEW_LEGENDARIES];
    gModernEmeraldConfig.tx_Mode_TypeEffectiveness           = sOptions->sel_mode[MENUITEM_MODE_NEW_EFFECTIVENESS];
    //MENU FEAUTRES
    gModernEmeraldConfig.tx_Features_RTCType                     = sOptions->sel_features[MENUITEM_FEATURES_RTC_TYPE];
    gModernEmeraldConfig.tx_Features_ShinyChance                 = sOptions->sel_features[MENUITEM_FEATURES_SHINY_CHANCE];
    gModernEmeraldConfig.tx_Features_WildMonDropItems            = sOptions->sel_features[MENUITEM_FEATURES_ITEM_DROP];
    gModernEmeraldConfig.tx_Features_EasierFeebas                = sOptions->sel_features[MENUITEM_FEATURES_EASY_FEEBAS];
    gModernEmeraldConfig.tx_Features_Unlimited_WT                = sOptions->sel_features[MENUITEM_FEATURES_UNLIMITED_WT];
    gModernEmeraldConfig.tx_Features_FrontierBans                = sOptions->sel_features[MENUITEM_FEATURES_FRONTIER_BANS];
    gModernEmeraldConfig.tx_Features_ShinyColors                 = sOptions->sel_features[MENUITEM_FEATURES_SHINY_COLOR];
    // MENU_RANDOMIZER
    if (sOptions->sel_randomizer[MENUITEM_RANDOM_OFF_ON] == TRUE)
    {
        gModernEmeraldConfig.tx_Random_Starter            = sOptions->sel_randomizer[MENUITEM_RANDOM_STARTER];
        gModernEmeraldConfig.tx_Random_WildPokemon        = sOptions->sel_randomizer[MENUITEM_RANDOM_WILD_PKMN];
        gModernEmeraldConfig.tx_Random_Trainer            = sOptions->sel_randomizer[MENUITEM_RANDOM_TRAINER];
        gModernEmeraldConfig.tx_Random_Static             = sOptions->sel_randomizer[MENUITEM_RANDOM_STATIC];
        gModernEmeraldConfig.tx_Random_Similar            = !sOptions->sel_randomizer[MENUITEM_RANDOM_SIMILAR_EVOLUTION_LEVEL];
        gModernEmeraldConfig.tx_Random_MapBased           = TX_RANDOM_MAP_BASED;
        gModernEmeraldConfig.tx_Random_IncludeLegendaries = sOptions->sel_randomizer[MENUITEM_RANDOM_INCLUDE_LEGENDARIES];
        gModernEmeraldConfig.tx_Random_Type               = sOptions->sel_randomizer[MENUITEM_RANDOM_TYPE];
        gModernEmeraldConfig.tx_Random_Moves              = sOptions->sel_randomizer[MENUITEM_RANDOM_MOVES];
        gModernEmeraldConfig.tx_Random_Abilities          = sOptions->sel_randomizer[MENUITEM_RANDOM_ABILITIES];
        gModernEmeraldConfig.tx_Random_Evolutions         = sOptions->sel_randomizer[MENUITEM_RANDOM_EVOLUTIONS];
        gModernEmeraldConfig.tx_Random_EvolutionMethods   = sOptions->sel_randomizer[MENUITEM_RANDOM_EVOLUTIONS_METHODS];
        gModernEmeraldConfig.tx_Random_TypeEffectiveness  = sOptions->sel_randomizer[MENUITEM_RANDOM_TYPE_EFFEC];
        gModernEmeraldConfig.tx_Random_Items              = sOptions->sel_randomizer[MENUITEM_RANDOM_ITEMS];
        gModernEmeraldConfig.tx_Random_Chaos              = sOptions->sel_randomizer[MENUITEM_RANDOM_CHAOS];
    }
    else
    {
        gModernEmeraldConfig.tx_Random_Starter            = FALSE;
        gModernEmeraldConfig.tx_Random_WildPokemon        = FALSE;
        gModernEmeraldConfig.tx_Random_Trainer            = FALSE;
        gModernEmeraldConfig.tx_Random_Static             = FALSE;
        gModernEmeraldConfig.tx_Random_Similar            = FALSE;
        gModernEmeraldConfig.tx_Random_MapBased           = FALSE;
        gModernEmeraldConfig.tx_Random_IncludeLegendaries = FALSE;
        gModernEmeraldConfig.tx_Random_Type               = FALSE;
        gModernEmeraldConfig.tx_Random_Moves              = FALSE;
        gModernEmeraldConfig.tx_Random_Abilities          = FALSE;
        gModernEmeraldConfig.tx_Random_Evolutions         = FALSE;
        gModernEmeraldConfig.tx_Random_EvolutionMethods   = FALSE;
        gModernEmeraldConfig.tx_Random_TypeEffectiveness  = FALSE;
        gModernEmeraldConfig.tx_Random_Chaos              = FALSE;
    }
    //MENU_NUZLOCKE
    switch (sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NUZLOCKE])
    {
    case 0:
        gModernEmeraldConfig.tx_Nuzlocke_EasyMode           = FALSE;
        gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke          = FALSE;
        gModernEmeraldConfig.tx_Nuzlocke_NuzlockeHardcore  = FALSE;
        break;
    case 1:
        gModernEmeraldConfig.tx_Nuzlocke_EasyMode           = TRUE;
        gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke          = FALSE;
        gModernEmeraldConfig.tx_Nuzlocke_NuzlockeHardcore  = FALSE;
        break;
    case 2:
        gModernEmeraldConfig.tx_Nuzlocke_EasyMode           = FALSE;
        gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke          = TRUE;
        gModernEmeraldConfig.tx_Nuzlocke_NuzlockeHardcore  = FALSE;
        break;
    case 3:
        gModernEmeraldConfig.tx_Nuzlocke_EasyMode           = FALSE;
        gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke          = TRUE;
        gModernEmeraldConfig.tx_Nuzlocke_NuzlockeHardcore  = TRUE;
        break;
    }
    if (gModernEmeraldConfig.tx_Nuzlocke_Nuzlocke)
    {
        gModernEmeraldConfig.tx_Nuzlocke_SpeciesClause   = !sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_SPECIES_CLAUSE];
        gModernEmeraldConfig.tx_Nuzlocke_ShinyClause     = !sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_SHINY_CLAUSE];
        gModernEmeraldConfig.tx_Nuzlocke_Nicknaming      = !sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NICKNAMING];
        gModernEmeraldConfig.tx_Nuzlocke_Deletion        = sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_DELETION];
    }
    else
    {
        gModernEmeraldConfig.tx_Nuzlocke_SpeciesClause   = FALSE;
        gModernEmeraldConfig.tx_Nuzlocke_ShinyClause     = FALSE;
        gModernEmeraldConfig.tx_Nuzlocke_Nicknaming      = FALSE;
    }
    // MENU_DIFFICULTY
    gModernEmeraldConfig.tx_Difficulty_PartyLimit    = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_PARTY_LIMIT];
    gModernEmeraldConfig.tx_Challenges_LevelCap      = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_LEVEL_CAP];
    gModernEmeraldConfig.tx_Challenges_ExpMultiplier = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_EXP_MULTIPLIER];
    gModernEmeraldConfig.tx_Challenges_LessEscapes   = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_LESS_ESCAPES];
    gModernEmeraldConfig.tx_Challenges_NoItemPlayer  = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_ITEM_PLAYER];
    gModernEmeraldConfig.tx_Challenges_NoItemTrainer = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_ITEM_TRAINER];
    gModernEmeraldConfig.tx_Challenges_NoEVs                 = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_NO_EVS];
    gModernEmeraldConfig.tx_Challenges_TrainerScalingIVs     = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_SCALING_IVS];
    gModernEmeraldConfig.tx_Challenges_TrainerScalingEVs     = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_SCALING_EVS];
    gModernEmeraldConfig.tx_Features_LimitDifficulty              = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_LIMIT_DIFFICULTY];
    gModernEmeraldConfig.tx_Challenges_MaxPartyIVs                         = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_MAX_PARTY_IVS];
    // MENU_CHALLENGES
    gModernEmeraldConfig.tx_Challenges_EvoLimit             = sOptions->sel_challenges[MENUITEM_CHALLENGES_EVO_LIMIT];
    if (sOptions->sel_challenges[MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE] > NUMBER_OF_MON_TYPES-1)
        gModernEmeraldConfig.tx_Challenges_OneTypeChallenge = TX_CHALLENGE_TYPE_OFF;
    else if (sOptions->sel_challenges[MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE] == NUMBER_OF_MON_TYPES-1)
        gModernEmeraldConfig.tx_Challenges_OneTypeChallenge = GetRandomType();
    else if (sOptions->sel_challenges[MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE] >= TYPE_MYSTERY)
        gModernEmeraldConfig.tx_Challenges_OneTypeChallenge = sOptions->sel_challenges[MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE] + 1;
    else
        gModernEmeraldConfig.tx_Challenges_OneTypeChallenge = sOptions->sel_challenges[MENUITEM_CHALLENGES_ONE_TYPE_CHALLENGE];
    gModernEmeraldConfig.tx_Challenges_BaseStatEqualizer    = sOptions->sel_challenges[MENUITEM_CHALLENGES_BASE_STAT_EQUALIZER];
    gModernEmeraldConfig.tx_Challenges_Mirror               = sOptions->sel_challenges[MENUITEM_CHALLENGES_MIRROR];
    gModernEmeraldConfig.tx_Challenges_Mirror_Thief         = sOptions->sel_challenges[MENUITEM_CHALLENGES_MIRROR_THIEF];
    gModernEmeraldConfig.tx_Challenges_PCHeal               = sOptions->sel_challenges[MENUITEM_CHALLENGES_PCHEAL];
    gModernEmeraldConfig.tx_Challenges_PkmnCenter           = sOptions->sel_challenges[MENUITEM_DIFFICULTY_POKECENTER];
    gModernEmeraldConfig.tx_Challenges_Expensive            = sOptions->sel_challenges[MENUITEM_CHALLENGES_EXPENSIVE];
    gModernEmeraldConfig.tx_Difficulty_EscapeRopeDig        = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_ESCAPE_ROPE_DIG];
    gModernEmeraldConfig.tx_Difficulty_HardExp              = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_HARD_EXP];
    gModernEmeraldConfig.tx_Difficulty_CatchRate            = sOptions->sel_difficulty[MENUITEM_DIFFICULTY_CATCH_RATE];
...
static void ReDrawAll(void)
{
    ...
    else
    {
        if (sOptions->arrowTaskId != TASK_NONE)
            RemoveScrollIndicatorArrowPair(sOptions->arrowTaskId);
        sOptions->arrowScrollOffset = sOptions->menuCursor[sOptions->submenu];
        sOptions->arrowTaskId = AddScrollIndicatorArrowPairParameterized(SCROLL_ARROW_UP, 240 / 2, 20, 110, MenuItemCount() - 1, 110, 110, &sOptions->arrowScrollOffset);
    }
...
static void DrawChoices_Mode_Classic_Modern_Selector(int selection, int y)
{
    ...
    if (selection == 0)
    {
        ...
        gModernEmeraldConfig.tx_Mode_Encounters = 0;
        sOptions->sel_mode[MENUITEM_MODE_INFINITE_TMS]              = TX_MODE_INFINITE_TMS;
        gModernEmeraldConfig.tx_Mode_InfiniteTMs = 0;
        FlagSet (FLAG_FINITE_TMS);
        sOptions->sel_mode[MENUITEM_MODE_SURVIVE_POISON]            = TX_MODE_SURVIVE_POISON;
        gModernEmeraldConfig.tx_Mode_PoisonSurvive = 0;
        sOptions->sel_mode[MENUITEM_MODE_SYNCHRONIZE]               = TX_MODE_NEW_SYNCHRONIZE;
        gModernEmeraldConfig.tx_Mode_Synchronize = 0;
        sOptions->sel_mode[MENUITEM_MODE_MINTS]                     = TX_MODE_MINTS;
        gModernEmeraldConfig.tx_Mode_Mints = 0;
        FlagClear (FLAG_MINTS_ENABLED);
        sOptions->sel_mode[MENUITEM_MODE_NEW_CITRUS]                = TX_MODE_NEW_CITRUS;
        gModernEmeraldConfig.tx_Mode_New_Citrus = 0;
        sOptions->sel_mode[MENUITEM_MODE_MODERN_TYPES]              = TX_MODE_MODERN_TYPES;
        gModernEmeraldConfig.tx_Mode_Modern_Types = 0;
        sOptions->sel_mode[MENUITEM_MODE_FAIRY_TYPES]               = TX_MODE_FAIRY_TYPES;
        gModernEmeraldConfig.tx_Mode_Fairy_Types = 0;
        sOptions->sel_mode[MENUITEM_MODE_NEW_STATS]                 = TX_MODE_NEW_STATS;
        gModernEmeraldConfig.tx_Mode_New_Stats = 0;
        sOptions->sel_mode[MENUITEM_MODE_STURDY]                    = TX_MODE_STURDY;
        gModernEmeraldConfig.tx_Mode_Sturdy = 0;
        sOptions->sel_mode[MENUITEM_MODE_MODERN_MOVES]              = TX_MODE_MODERN_MOVES;
        gModernEmeraldConfig.tx_Mode_Modern_Moves = 0;
        sOptions->sel_mode[MENUITEM_MODE_LEGENDARY_ABILITIES]       = TX_MODE_LEGENDARY_ABILITIES;
        gModernEmeraldConfig.tx_Mode_Legendary_Abilities = 0;
        sOptions->sel_mode[MENUITEM_MODE_NEW_LEGENDARIES]           = TX_MODE_NEW_LEGENDARIES;
        gModernEmeraldConfig.tx_Mode_New_Legendaries = 0;
        sOptions->sel_mode[MENUITEM_MODE_NEW_EFFECTIVENESS]         = TX_MODE_TYPE_EFFECTIVENESS;
        gModernEmeraldConfig.tx_Mode_TypeEffectiveness = 0;
    }
    else if (selection == 1)
    {
        sOptions->sel_mode[MENUITEM_MODE_ALTERNATE_SPAWNS]          = !TX_MODE_ALTERNATE_SPAWNS;
        gModernEmeraldConfig.tx_Mode_Encounters = 1;
        sOptions->sel_mode[MENUITEM_MODE_INFINITE_TMS]              = !TX_MODE_INFINITE_TMS;
        gModernEmeraldConfig.tx_Mode_InfiniteTMs = 1;
        FlagClear (FLAG_FINITE_TMS);
        sOptions->sel_mode[MENUITEM_MODE_SURVIVE_POISON]            = !TX_MODE_SURVIVE_POISON;
        gModernEmeraldConfig.tx_Mode_PoisonSurvive = 1;
        sOptions->sel_mode[MENUITEM_MODE_SYNCHRONIZE]               = !TX_MODE_NEW_SYNCHRONIZE;
        gModernEmeraldConfig.tx_Mode_Synchronize = 1;
        sOptions->sel_mode[MENUITEM_MODE_MINTS]                     = !TX_MODE_MINTS;
        gModernEmeraldConfig.tx_Mode_Mints = 1;
        FlagSet (FLAG_MINTS_ENABLED);
        sOptions->sel_mode[MENUITEM_MODE_NEW_CITRUS]                = !TX_MODE_NEW_CITRUS;
        gModernEmeraldConfig.tx_Mode_New_Citrus = 1;
        sOptions->sel_mode[MENUITEM_MODE_MODERN_TYPES]              = !TX_MODE_MODERN_TYPES;
        gModernEmeraldConfig.tx_Mode_Modern_Types = 1;
        sOptions->sel_mode[MENUITEM_MODE_FAIRY_TYPES]               = !TX_MODE_FAIRY_TYPES;
        gModernEmeraldConfig.tx_Mode_Fairy_Types = 1;
        sOptions->sel_mode[MENUITEM_MODE_NEW_STATS]                 = !TX_MODE_NEW_STATS;
        gModernEmeraldConfig.tx_Mode_New_Stats = 1;
        sOptions->sel_mode[MENUITEM_MODE_STURDY]                    = !TX_MODE_STURDY;
        gModernEmeraldConfig.tx_Mode_Sturdy = 1;
        sOptions->sel_mode[MENUITEM_MODE_MODERN_MOVES]              = !TX_MODE_MODERN_MOVES;
        gModernEmeraldConfig.tx_Mode_Modern_Moves = 1;
        sOptions->sel_mode[MENUITEM_MODE_LEGENDARY_ABILITIES]       = !TX_MODE_LEGENDARY_ABILITIES;
        gModernEmeraldConfig.tx_Mode_Legendary_Abilities = 1;
        sOptions->sel_mode[MENUITEM_MODE_NEW_LEGENDARIES]           = !TX_MODE_NEW_LEGENDARIES;
        gModernEmeraldConfig.tx_Mode_New_Legendaries = 1;
        sOptions->sel_mode[MENUITEM_MODE_NEW_EFFECTIVENESS]         = !TX_MODE_TYPE_EFFECTIVENESS;
        gModernEmeraldConfig.tx_Mode_TypeEffectiveness = 1;
    }
}
...
static void DrawChoices_Challenges_Nuzlocke(int selection, int y)
{
    ...
    if (selection == 0)
    {
        ...
        gModernEmeraldConfig.tx_Nuzlocke_EasyMode = 0; //off
    }
    else if (selection == 1)
    {
        sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_SPECIES_CLAUSE]    = !TX_NUZLOCKE_SPECIES_CLAUSE;
        ...
        sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_NICKNAMING]        = !TX_NUZLOCKE_NICKNAMING;
        sOptions->sel_nuzlocke[MENUITEM_NUZLOCKE_DELETION]          = TX_NUZLOCKE_DELETION;
        gModernEmeraldConfig.tx_Nuzlocke_EasyMode = 1; //on
    }
    else
        gModernEmeraldConfig.tx_Nuzlocke_EasyMode = 0; //off
...
static void DrawChoices_Features_Rtc_Type(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_RTCType = 0; //Off, RTC
    }
    else
    {
        gModernEmeraldConfig.tx_Features_RTCType = 1; //On, Fake RTC
    }
...
static void DrawChoices_Mode_AlternateSpawns(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Encounters = 0; //Vanilla, unmodified encounters
    }
    else if (selection == 1)
    {
        gModernEmeraldConfig.tx_Mode_Encounters = 1; //Full modern encounters
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Encounters = 2; //Vanilla encounters, with post-game pokémon
    }
...
static void DrawChoices_Challenges_LimitDifficulty(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_LimitDifficulty = 0; //Don't limit difficulty
    }
    else
    {
        gModernEmeraldConfig.tx_Features_LimitDifficulty = 1; //limit difficulty
    }
...
static void DrawChoices_Challenges_MaxPartyIVs(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Challenges_MaxPartyIVs = 0; //Ivs set to normal
    }
    else if (selection == 1)
    {
        gModernEmeraldConfig.tx_Challenges_MaxPartyIVs = 1; //Ivs are always 31
    }
    else
    {
        gModernEmeraldConfig.tx_Challenges_MaxPartyIVs = 2; //Ivs are set between 30 and 31
    }
...
static void DrawChoices_Features_ItemDrop(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_WildMonDropItems = 0; //items don't drop
    }
    else
    {
        gModernEmeraldConfig.tx_Features_WildMonDropItems = 1; //items do drop
    }
...
static void DrawChoices_Mode_InfiniteTMs(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_InfiniteTMs = 0; //TMs are finite
        FlagSet (FLAG_FINITE_TMS);
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_InfiniteTMs = 1; //TMs are infinite
        FlagClear (FLAG_FINITE_TMS);
    }
...
static void DrawChoices_Mode_SurvivePoison(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_PoisonSurvive = 0; //Poison will kill
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_PoisonSurvive = 1; //1hp survive poison
    }
...
static void DrawChoices_Features_EasyFeebas(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_EasierFeebas = 0; //off
    }
    else
    {
        gModernEmeraldConfig.tx_Features_EasierFeebas = 1; //on
    }
...
static void DrawChoices_Challenges_PCHeal(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Challenges_PCHeal = 0; //PC heal enabled
    }
    else
    {
        gModernEmeraldConfig.tx_Challenges_PCHeal = 1; //PC heal disabled
    }
...
static void DrawChoices_Features_ShinyChance(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_ShinyChance = 0; // 1/8192
    }
    else if (selection == 1)
    {
        gModernEmeraldConfig.tx_Features_ShinyChance = 1; // 1/4096 -> Gen VI
    }
    else if (selection == 2)
    {
        gModernEmeraldConfig.tx_Features_ShinyChance = 2; // 1/2048
    }
    else if (selection == 3)
    {
        gModernEmeraldConfig.tx_Features_ShinyChance = 3; // 1/1024
    }
    else //(selection == 4)
    {
        gModernEmeraldConfig.tx_Features_ShinyChance = 4; // 1/512
    }
}
...
static void DrawChoices_Features_Unlimited_WT(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_Unlimited_WT = 0; //WTs are capped to 3 daily
        FlagClear (FLAG_UNLIMITIED_WONDERTRADE);
    }
    else
    {
        gModernEmeraldConfig.tx_Features_Unlimited_WT = 1; //WTs are uncapped
...
static void DrawChoices_Mode_Synchronize(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Synchronize = 0; //Old synchronize
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Synchronize = 1; //New synchronize
    }
...
static void DrawChoices_Mode_Mints(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Mints = 0; //No mints
        FlagClear (FLAG_MINTS_ENABLED);
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Mints = 1; //Yes mints
        FlagSet (FLAG_MINTS_ENABLED);
    }
...
static void DrawChoices_Mode_New_Citrus(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_New_Citrus = 0; //No new citrus, old citrus
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_New_Citrus = 1; //Yes new citrus
    }
...
static void DrawChoices_Mode_Modern_Types(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Modern_Types = 0; //No type changes, except fairy
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Modern_Types = 1; //New typings
    }
...
static void DrawChoices_Mode_Fairy_Types(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Fairy_Types = 0; //Pkmn who have fairy since GEN VI don't have it
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Fairy_Types = 1; //They do now
    }
...
static void DrawChoices_Mode_New_Stats(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_New_Stats = 0; //Old stats
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_New_Stats = 1; //New stats
    }
...
static void DrawChoices_Mode_Sturdy(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Sturdy = 0; //Old sturdy
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Sturdy = 1; //New sturdy
    }
...
static void DrawChoices_Mode_Modern_Moves(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Modern_Moves = 0; //Old movepool, and moves
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Modern_Moves = 1; //New movepool, and moves
    }
...
static void DrawChoices_Mode_New_Effectiveness(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_TypeEffectiveness = 0; //Old type chart
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_TypeEffectiveness = 1; //New type chart
    }
...
static void DrawChoices_Mode_Legendary_Abilities(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_Legendary_Abilities = 0; //Pressure as main ability
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_Legendary_Abilities = 1; //New abilities
    }
...
static void DrawChoices_Mode_New_Legendaries(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Mode_New_Legendaries = 0; //No extra legendaries
        FlagClear (FLAG_EXTRA_LEGENDARIES);
    }
    else
    {
        gModernEmeraldConfig.tx_Mode_New_Legendaries = 1; //7 extra legendaries
...
static void DrawChoices_Challenges_LessEscapes(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Challenges_LessEscapes = 0; //Run away as usual
    }
    else
    {
        gModernEmeraldConfig.tx_Challenges_LessEscapes = 1; //Less running away
    }
...
static void DrawChoices_Difficulty_Escape_Rope_Dig(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Difficulty_EscapeRopeDig = 0; //YES, Escape rope and dig are allowed. DEFAULT.
    }
    else
    {
        gModernEmeraldConfig.tx_Difficulty_EscapeRopeDig = 1; //NO, Escape rope and dig are disallowed
    }
...
static void DrawChoices_Features_FrontierBans(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_FrontierBans = 0; //Ban
    }
    else
    {
        gModernEmeraldConfig.tx_Features_FrontierBans = 1; //Unban
    }
...
static void DrawChoices_Difficulty_HardExp(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Difficulty_HardExp = 0; //50% EXP gain in HARD
    }
    else
    {
        gModernEmeraldConfig.tx_Difficulty_HardExp = 1; //100% (usual) EXP gain in HARD
    }
...
static void DrawChoices_Difficulty_CatchRate(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Difficulty_CatchRate = 0; // Normal, Set to 1 for save compatibiity reasons
    }
    else if (selection == 1)
    {
        gModernEmeraldConfig.tx_Difficulty_CatchRate = 1; // Half, Set to 1 for save compatibiity reasons
    }
    else if (selection == 2)
    {
        gModernEmeraldConfig.tx_Difficulty_CatchRate = 2; // Double
    }
    else
    {
        gModernEmeraldConfig.tx_Difficulty_CatchRate = 3; // Triple
    }
}
...
static void DrawChoices_Features_Shiny_Colors(int selection, int y)
{
    ...
    if (selection == 0)
    {
        gModernEmeraldConfig.tx_Features_ShinyColors = 0; //Old shinies
    }
    else
    {
        gModernEmeraldConfig.tx_Features_ShinyColors = 1; //New shinies
    }
